...
export const uploadFile = async (req, res, next) => {
  try {
    ...
    // Pour admin.swigs.online, on utilise le domaine principal du site
    const primaryDomain = site.domains?.find(d => d.isPrimary)?.url || site.domain;
    const fileUrl = `https://${primaryDomain}/uploads/${site.slug}/${req.file.filename}`;
