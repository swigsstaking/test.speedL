...
// @desc    Update site pages
// @route   PUT /api/sites/:id/pages
// @access  Private
export const updateSitePages = async (req, res, next) => {
  try {
    const { id } = req.params;
...
// @desc    Update site sections
// @route   PUT /api/sites/:id/sections
// @access  Private
export const updateSiteSections = async (req, res, next) => {
  try {
    const { id } = req.params;
